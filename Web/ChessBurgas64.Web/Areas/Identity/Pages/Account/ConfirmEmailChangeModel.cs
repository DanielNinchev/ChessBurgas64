namespace ChessBurgas64.Web.Areas.Identity.Pages.Account
{
    ...
    public class ConfirmEmailChangeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string email, string code)
        {
            ...
            if (!result.Succeeded)
            {
                this.StatusMessage = ErrorMessages.EmailChangeError;
                return this.Page();
            }
            ...
            {
                this.StatusMessage = ErrorMessages.UsernameChangeError;
                return this.Page();
            }

            await this.signInManager.RefreshSignInAsync(user);
            this.StatusMessage = GlobalConstants.EmailSuccessfulChangeMsg;
            return this.Page();
        }
    }
}
