namespace ChessBurgas64.Common
{
    ...
    {
        // ORDER OF NON-STATIC CONSTANTS:
        // 1. DATA MODELS
        // 2. EMAIL MESSAGES
        // 3. HTML ELEMENTS
        // 4. SYSTEM AND ADMINISTRATION
        // 5. VIEWS
        ...
        // Cookies
        public const string CookiesInfo = "Достъпвайки нашия уебсайт, Вие се съгласявате да използвате бисквитки съгласно политиката ни за поверителност на личните данни. Повечето уебсайтове ползват бисквитки с цел събиране на информация за посещенията на своите потребители. Ние използваме следните видове бисквитки:";
        public const string CookiesManagement = "Управление на настройките на бисквитките";
        public const string CookiesManagementInfo = "Можете да оттеглите съгласието си за използване на бисквитки по всяко време чрез настройките на уеб браузъра си. Ако искате да изтриете бисквитки, съхранявани на Вашето устройство и да конфигурирате Вашия браузър да ги отказва, обикновено можете да го направите от менюто „Опции“, „Инструменти“ или „Предпочитания“ на Вашия браузър, който използвате за достъп до нашия сайт. Бисквитките могат да бъдат деактивирани по различни начини в зависимост от съществуващите уеб браузъри. За повече информация как да го направите, посетете уебсайта на Вашия браузър.";
        public const string FunctionalCookies = "Функционални бисквитки, служещи за разпознаването Ви при всяко следващо посещение, които позволяват запаметяването на Ваши предпочитания за Ваше удобство.";
        public const string NecessaryCookies = "Необходими бисквитки, позволяващи Ви да сърфирате в приложението и да работите с основните му функции. Те са задължителни, ако искате да се възползвате от всички услуги на сайта.";
        public const string PersonalDataUsageAfterRegistrationInfo = "След завършването на регистрацията Ви в сайта Вие ни предоставяте лични данни, които ние съхраняваме и използваме за определени цели. Можете по всяко време да ги променяте, изтегляте или изтриете безвъзвратно от менюто \"Поверителност\" на Вашия профил.";
        public const string WeUseCookies = "Използваме бисквитки, за да подобрим Вашето обслужване.";
        ...
        public const string StudentStatusInfo = "Изберете тази опция, ако вече сте заплатили месечна такса, включени сте в графика и посещавате тренировки в клуба.";
