...
namespace ChessBurgas64.Data.Migrations
{
    ...
    [Migration("20220505215854_ChangeClubPlayerToNotableMemberAndRemoveTrainerImagesAndDateOfJoningCurrentGroup")]
    partial class ChangeClubPlayerToNotableMemberAndRemoveTrainerImagesAndDateOfJoningCurrentGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.AnnouncementCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.GroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.Image", b =>
                {
                    ...
                    b.Property<int?>("NotableMemberId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NotableMemberId")
                        .IsUnique()
                        .HasFilter("[NotableMemberId] IS NOT NULL");
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.NotableMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsPartOfGovernance")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.PuzzleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.Announcement", b =>
                {
                    ...
                    b.HasOne("ChessBurgas64.Data.Models.AnnouncementCategory", "Category")
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.Image", b =>
                {
                    ...
                    b.HasOne("ChessBurgas64.Data.Models.NotableMember", "NotableMember")
                        .WithOne("Image")
                        .HasForeignKey("ChessBurgas64.Data.Models.Image", "NotableMemberId");
            ...
            modelBuilder.Entity("ChessBurgas64.Data.Models.Puzzle", b =>
                {
                    b.HasOne("ChessBurgas64.Data.Models.PuzzleCategory", "Category")
                        .WithMany("Puzzles")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
